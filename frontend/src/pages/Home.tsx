    ...
    >
      ...
      <main style={{ padding: '16px', maxWidth: '1200px', margin: '0 auto', ...getMainContentStyle(false) }}>
        {(isAuthenticated || isGuestMode) ? (
          ...
          /* Landing Page Premium pour non-authentifiés (Style Gastronomique Stitch) */
          <div style={{ display: 'flex', flexDirection: 'column', gap: '80px', padding: '24px 0' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '24px' }}>
                <div 
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '8px',
                    backgroundColor: '#cbe3d2', // Sage-light
                    color: '#4e6356', // Sage-dark
                    padding: '6px 14px',
                    borderRadius: '9999px',
                    fontSize: '13px',
                    fontWeight: 'bold',
                ...
                <h1
                  style={{
                    ...
                    lineHeight: '1.15',
                    margin: 0,
                    color: '#1e1b18', // Deep Charcoal
                    letterSpacing: '-0.02em',
                  }}
                >
                  Cuisinez moins, <br/>
                  <span style={{ color: '#92432e' }}>diversifiez vos saveurs</span>
                </h1>
                <p
                  style={{
                    fontSize: '16px',
                    color: '#4A4542', // Charcoal Muted
                    lineHeight: '1.6',
                    margin: 0,
                    maxWidth: '520px',
                  }}
                >
                  Rejoignez SOLID'EAT, la communauté bienveillante de partage de repas faits maison. Dégustez de bons plats cuisinés par vos voisins, gagnez du temps et agissez concrètement pour l'environnement.
                </p>
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginTop: '12px' }}>
                  <button
                    ...
                    style={{
                      backgroundColor: '#92432e', // Terracotta
                      color: colors.backgroundWhite,
                      padding: '14px 28px',
                      borderRadius: '8px', // ROUND_EIGHT
                      fontSize: '15px',
                      fontWeight: 'bold',
                      border: 'none',
                      cursor: 'pointer',
                  ...
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: '15px',
                      fontWeight: 'bold',
                      border: '1px solid #D1DBD3', // Sage-light
                      boxShadow: 'var(--shadow-sm)',
                    }}
                  >
                    Créer un compte
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div className="ui-mockup" style={{ width: '100%', maxWidth: '380px', padding: '16px' }}>
                  ...
                  <h3 style={{ fontSize: '15px', fontWeight: 'bold', color: '#1e1b18', margin: '0 0 6px 0' }}>Bowl Végétarien & Sauce Sésame</h3>
                  <p style={{ fontSize: '13px', color: '#4A4542', margin: '0 0 16px 0', lineHeight: '1.4' }}>
                    Quinoa bio, avocat, patates douces rôties, pois chiches croustillants et vinaigrette maison.
                  </p>
                  {/* Footer du repas */}
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid #e9e1dc' }}>
                    <div>
                      <span style={{ fontSize: '11px', color: '#4A4542' }}>Portions</span>
                      <p style={{ margin: 0, fontSize: '14px', fontWeight: 'bold', color: '#1e1b18' }}>3 parts dispo.</p>
                    </div>
                    <button 
                      style={{ 
                        backgroundColor: '#92432e', 
                        color: colors.backgroundWhite, 
                        border: 'none', 
                        padding: '8px 16px', 
                        borderRadius: '8px', 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', alignItems: 'center' }}>
              <div style={{ textAlign: 'center', maxWidth: '600px' }}>
                <h2 style={{ fontSize: '26px', fontWeight: 800, color: '#1e1b18', marginBottom: '12px', letterSpacing: '-0.01em' }}>Comment ça marche ?</h2>
                <p style={{ fontSize: '15px', color: '#4A4542' }}>Une plateforme solidaire et conviviale pensée pour faciliter votre quotidien tout en agissant pour la planète.</p>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', width: '100%' }}>
                ...
                <div className="feature-card" style={{ padding: '32px 24px', borderRadius: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <p style={{ fontSize: '14px', color: '#4A4542', lineHeight: '1.6', margin: 0 }}>
                    Découvrez des spécialités culinaires variées préparées par vos voisins, et gagnez du temps sur la préparation de vos repas.
                  </p>
                </div>
            ...
            <div 
              style={{ 
                backgroundColor: '#f5ece7', // Surface container
                borderRadius: '16px', 
                padding: '40px 24px', 
                display: 'grid', 
            ...
            >
              <div>
                <p style={{ fontSize: '36px', fontWeight: 800, color: '#92432e', margin: '0 0 4px 0' }}>320+</p>
                <p style={{ fontSize: '14px', color: '#4A4542', fontWeight: 500, margin: 0 }}>Repas partagés</p>
              </div>
              <div>
                <p style={{ fontSize: '36px', fontWeight: 800, color: '#64594a', margin: '0 0 4px 0' }}>120+</p>
                <p style={{ fontSize: '14px', color: '#4A4542', fontWeight: 500, margin: 0 }}>Chefs inscrits</p>
              </div>
              <div>
                <p style={{ fontSize: '36px', fontWeight: 800, color: '#4e6356', margin: '0 0 4px 0' }}>1.2 T</p>
                <p style={{ fontSize: '14px', color: '#4A4542', fontWeight: 500, margin: 0 }}>CO₂ économisés</p>
              </div>
            </div>
